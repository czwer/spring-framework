...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓");
		logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】开始");
		...
		try {
			...
			try {
				...
				logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】调用invokeBeanFactoryPostProcessors：执行BeanFactory后处理器");
				invokeBeanFactoryPostProcessors(beanFactory);
				// Register bean processors that intercept bean creation.
				logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】调用registerBeanPostProcessors：注册Bean后处理器");
				...
				logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】调用finishBeanFactoryInitialization：完成BeanFactory初始化");
		...
		logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】结束");
		logger.info("[SPRING] 自定义日志【非常重要】---【AbstractApplicationContext_refresh】↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑");
	}
	...
	protected void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		logger.info("[SPRING] 自定义日志---执行postProcessBeanFactory方法：当前为空方法");
	}
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		logger.info("[SPRING] 自定义日志【非常重要】---调用AbstractApplicationContext的refresh方法（invokeBeanFactoryPostProcessors），再调用PostProcessorRegistrationDelegate的invokeBeanFactoryPostProcessors方法：开始");
		PostProcessorRegistrationDelegate.invokeBeanFactoryPostProcessors(beanFactory, getBeanFactoryPostProcessors());
		logger.info("[SPRING] 自定义日志【非常重要】---调用AbstractApplicationContext的refresh方法（invokeBeanFactoryPostProcessors），再调用PostProcessorRegistrationDelegate的invokeBeanFactoryPostProcessors方法：完成");
