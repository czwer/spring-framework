...
public class RequestMappingHandlerAdapter extends AbstractHandlerMethodAdapter
	...
	protected final Log logger = LogFactory.getLog(RequestMappingHandlerAdapter.class);
	/**
	...
	private LocaleResolver initLocaleResolver() {
		if (getBeanFactory() != null) {
			try {
				logger.info("[SPRING] 自定义日志---调用getBean："+DispatcherServlet.LOCALE_RESOLVER_BEAN_NAME);
